...
public class IP {
    ...
    static final String DB_URL = "jdbc:sqlserver://ayya0005-sql-server.database.windows.net:1433;"
    		+ "database=cs-dsa-4513-sql-db;user=ayya0005@ayya0005-sql-server;password={Sujan@123456};"
